...
PI = 3.1415926
omega = 2.0*PI*fre
niter = 50000#50000 #for homogeneous model
...
class PhysicsInformedNN:
    ...
    def neural_net(self, X, weights, biases, w0): # 神经网络结构
...
if __name__ == "__main__": 
    ...
    scipy.io.savemat('./results/Helm_pinn_sine_adaptive.py/lab002/loss_adam_sine_adaptive_mar.mat',{'misfit':misfit})
    scipy.io.savemat('./results/Helm_pinn_sine_adaptive.py/lab002/loss_lbfgs_sine_adaptive_mar.mat',{'misfit1':misfit1})
    ...
    scipy.io.savemat('./results/Helm_pinn_sine_adaptive.py/lab001/u_real_pred_sine_adaptive_mar.mat',{'u_real_pred':u_real_pred})
    scipy.io.savemat('./results/Helm_pinn_sine_adaptive.py/lab001/u_imag_pred_sine_adaptive_mar.mat',{'u_imag_pred':u_imag_pred})
