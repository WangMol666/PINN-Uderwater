...
PI = 3.1415926
omega = 2.0*PI*fre
niter = 50000 #30000 #for homogeneous model
...
class PhysicsInformedNN:
    ...
    def neural_net(self, X, weights, biases):
        ...
        for l in range(0,num_layers-2):
            W = weights[l]
            b = biases[l]
            H = tf.tanh(tf.add(tf.matmul(H, W), b)) #使用tanh作为激活函数
        W = weights[-1]
        b = biases[-1]
...
if __name__ == "__main__": 
    ...
    scipy.io.savemat('./results/Helm_pinn_tanh.py/lab003/loss_adam_tanh.mat',{'misfit':misfit})
    scipy.io.savemat('./results/Helm_pinn_tanh.py/lab003/loss_lbfgs_tanh.mat',{'misfit1':misfit1})
    ...
    scipy.io.savemat('./results/Helm_pinn_tanh.py/lab003/u_real_pred_tanh_mar.mat',{'u_real_pred':u_real_pred})
    scipy.io.savemat('./results/Helm_pinn_tanh.py/lab003/u_imag_pred_tanh_mar.mat',{'u_imag_pred':u_imag_pred})

    scipy.io.savemat('./results/Helm_pinn_tanh.py/lab003/u_real_star_4hz_mar.mat',{'u_real_star':u_real_star})
    scipy.io.savemat('./results/Helm_pinn_tanh.py/lab003/u_imag_star_4hz_mar.mat',{'u_imag_star':u_imag_star})
